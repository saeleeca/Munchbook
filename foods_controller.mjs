 ...
 */
 app.post('/foods', (req, res) => {
    foods.createFood(req.body.name, req.body.servings, req.body.type, req.body.date)
 ...
 */
 app.put('/foods/:_id', (req, res) => {
    ...
    foods.replaceFood(req.params._id, req.body.name, req.body.servings, req.body.type, req.body.date)
        .then(numUpdated => {
            if (numUpdated === 1) {
                res.json({ _id: req.params._id, name: req.body.name, servings: req.body.servings, type: req.body.type, date: req.body.date });
            } 
