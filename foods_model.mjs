...
const createFood = async (name, servings, type, date) => {
    ...
    const food = new Food({ name: name, servings: servings, type: type, date: date });
    return food.save();
};
...
const replaceFood = async (_id, name, servings, type, date) => {
    ...
    const result = await Food.replaceOne({ _id: _id}, { name: name, servings: servings, type: type, date: date });
